...
public class GenerateOTP extends RESTWorkItemHandler {
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
		...
		System.out.println("GenerateOTP v1.3.8");
	...
	//	serverURL = "http://prd-plt-as-04.fx.lan:8080/rest/";
		...
		jsonString = "{\"from\": \""+from+"\",\"text\": \""+message+"\",\"to\": \""+number+"\",\"api_key\": \"e54ec738\",\"api_secret\": \"2c10be8a\"}";
		customworkItem.setParameter("ContentData", jsonString);
		customworkItem.setParameter("ContentType", "application/json");
		customworkItem.setParameter("Url","https://rest.nexmo.com/sms/json"  );
		customworkItem.setParameter("Method", "POST");
		System.out.println("executeWorkItem 2 getParameters : " + customworkItem.getParameters());
		super.executeWorkItem(customworkItem, manager);
		System.out.println("executeWorkItem 2 DONE : " + results);
