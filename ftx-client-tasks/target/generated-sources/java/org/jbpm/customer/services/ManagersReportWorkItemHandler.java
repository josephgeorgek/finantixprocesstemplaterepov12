...
@Wid(widfile = "ManagersReportWorkItemHandler.wid", name = "ManagersReportWorkItemHandler",
        ...
        documentation = "ftx-client-tasks/index.html",
        category = "ftx-client-tasks",
        icon = "email.png",
        parameters = {
                @WidParameter(name = "URL", required = true)
        },
        mavenDepends = {
                @WidMavenDepends(group = "com.finantix.jbpm", artifact = "ftx-client-tasks", version = "7.35.0.Final")
        },
        serviceInfo = @WidService(category = "FTX", description = "Create ftx services",
