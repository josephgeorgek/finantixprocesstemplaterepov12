...
public class AddressDTO implements java.io.Serializable {
	...
	public AddressDTO(java.lang.String addressType, java.lang.String city,
			java.lang.String country, java.lang.Integer id,
			java.lang.String postalCode, java.lang.Boolean preferred,
			java.lang.String street, java.lang.Integer yearsAtAddress) {
		this.addressType = addressType;
		this.city = city;
		this.country = country;
		this.id = id;
